...
<?
	if(isset($compartilhe)){
		...
		<?=isset($compartilhe['facebook']) ? "<a href='{$compartilhe['facebook']}' target='_blank'><img src='/estaticos/img/btn_facebook.jpg' border='0' alt='' /></a>" : ''?>
		<?=isset($compartilhe['twitter']) ? "<a href='{$compartilhe['twitter']}' target='_blank'><img src='/estaticos/img/btn_twitter.jpg' border='0' alt='' /></a>" : ''?>
		</div>
		<?
	}
